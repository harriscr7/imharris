...
Class SliceWP {
	...
	public function enqueue_front_end_scripts() {
		...
		wp_register_script( 'slicewp-script', SLICEWP_PLUGIN_DIR_URL . 'assets/js/script-front-end-vanilla.js', array( 'slicewp-script-lib-litepicker' ), SLICEWP_VERSION, true );
