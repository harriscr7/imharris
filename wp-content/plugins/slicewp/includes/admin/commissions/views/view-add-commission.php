				...
				<div class="slicewp-card slicewp-first">
					...
					<div class="slicewp-card-inner">
						...
						<div class="slicewp-field-wrapper slicewp-field-wrapper-inline">
							...
							<input id="slicewp-commission-date-created" name="date_created" type="text" class="slicewp-dtpicker" autocomplete="off" value="<?php echo ( ! empty( $_POST['date_created'] ) ? esc_attr( $_POST['date_created'] ) : '' ); ?>" />
