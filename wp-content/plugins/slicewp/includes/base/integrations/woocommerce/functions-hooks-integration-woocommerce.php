...
function slicewp_add_order_note_woo( $commission_id, $commission_data ) {
	...
	$order->add_order_note( sprintf( __( 'A %s commission (%s) has been registered for affiliate %s (%s)', 'slicewp' ),
		...
		'<a href="' . add_query_arg( array( 'page' => 'slicewp-commissions', 'subpage' => 'edit-commission', 'commission_id' => absint( $commission_id ) ), admin_url( 'admin.php' ) ) . '">' . '#' . absint( $commission_id ) . '</a>',
		slicewp_get_affiliate_name( absint( $commission_data['affiliate_id'] ) ),
		'<a href="' . add_query_arg( array( 'page' => 'slicewp-affiliates', 'subpage' => 'edit-affiliate', 'affiliate_id' => absint( $commission_data['affiliate_id'] ) ), admin_url( 'admin.php' ) ) . '">' . '#' . absint( $commission_data['affiliate_id'] ) . '</a>'
	) );
