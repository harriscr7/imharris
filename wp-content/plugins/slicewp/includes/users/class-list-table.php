...
class SliceWP_List_Table {
    ...
    public function output_table_filters() {
        ...
        echo '<div class="slicewp-list-table-filters">';
            ...
            echo '<form method="GET">';
                ...
                $this->output_table_filter_date_range_picker();
    ...
    public function output_table_filter_date_range_picker() {
        ...
        echo '<div class="slicewp-date-picker-wrapper">';

            echo '<div class="slicewp-date-picker-input">';
                echo slicewp_get_svg( 'solid-clock' );
                echo '<span>' . __( 'All time', 'slicewp' ) . '</span>';
            echo '</div>';

            echo '<div class="slicewp-date-picker-modal">';

                echo '<div class="slicewp-date-picker-predefined-date-ranges">';
                    echo '<a href="#" class="slicewp-date-picker-predefined-date-range" data-range="past_7_days">' . __( 'Past 7 days', 'slicewp' ) . '</a>';
                    echo '<a href="#" class="slicewp-date-picker-predefined-date-range" data-range="past_30_days">' . __( 'Past 30 days', 'slicewp' ) . '</a>';
                    echo '<a href="#" class="slicewp-date-picker-predefined-date-range" data-range="week_to_date">' . __( 'Week to date', 'slicewp' ) . '</a>';
                    echo '<a href="#" class="slicewp-date-picker-predefined-date-range" data-range="month_to_date">' . __( 'Month to date', 'slicewp' ) . '</a>';
                    echo '<a href="#" class="slicewp-date-picker-predefined-date-range" data-range="year_to_date">' . __( 'Year to date', 'slicewp' ) . '</a>';
                    echo '<a href="#" class="slicewp-date-picker-predefined-date-range" data-range="last_week">' . __( 'Last week', 'slicewp' ) . '</a>';
                    echo '<a href="#" class="slicewp-date-picker-predefined-date-range" data-range="last_month">' . __( 'Last month', 'slicewp' ) . '</a>';
                    echo '<a href="#" class="slicewp-date-picker-predefined-date-range" data-range="last_year">' . __( 'Last year', 'slicewp' ) . '</a>';
                    echo '<a href="#" class="slicewp-date-picker-predefined-date-range" data-range="all_time">' . __( 'All time', 'slicewp' ) . '</a>';
                echo '</div>';

                echo '<div class="slicewp-date-picker"></div>';

            echo '</div>';

            echo '<input class="slicewp-date-picker-input-date-start" type="hidden" name="list-table-filter-date-start" value="' . esc_attr( ! empty( $_GET['list-table-filter-date-start'] ) ? $_GET['list-table-filter-date-start'] : '' ) . '" />';
            echo '<input class="slicewp-date-picker-input-date-end" type="hidden" name="list-table-filter-date-end" value="' . esc_attr( ! empty( $_GET['list-table-filter-date-end'] ) ? $_GET['list-table-filter-date-end'] : '' ) . '" />';
